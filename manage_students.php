...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (isset($_POST['edit_id']) && $_POST['edit_id'] != '') {
        ...
        $query = "INSERT INTO students (student_id, first_name, last_name, email, phone, class, section, enrollment_year, status) 
                  VALUES ('$student_id', '$first_name', '$last_name', '$email', '$phone', '$class', '$section', '$enrollment_year', '$status')";
...
// Get students with pagination - ORDER BY id ASC (oldest first, newest at bottom)
$students = mysqli_query($conn, "SELECT * FROM students ORDER BY id ASC LIMIT $offset, $limit");
...
<body>
        ...
        <div class="nav-container">
            ...
            <ul class="nav-menu">
                ...
                <?php if($user_role == 'admin'): ?>
                    <li class="active"><a href="manage_students.php"><i class="fas fa-users"></i> Students</a></li>
    ...
    <div class="main-container">
            ...
            <form method="POST" action="" id="studentForm">
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="text" name="student_id" id="student_id" required placeholder="e.g., STU001">
                    </div>
                    <div class="form-group">
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="email" name="email" id="email" placeholder="student@example.com">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="class" id="class" placeholder="e.g., Grade 10">
                    </div>
                </div>
                <div class="form-row">
                    <div class="form-group">
                        <label><i class="fas fa-layer-group"></i> Section</label>
                        <input type="text" name="section" id="section" placeholder="e.g., A, B, C">
                    </div>
                    <div class="form-group">
                        <label><i class="fas fa-calendar"></i> Enrollment Year</label>
                        <input type="number" name="enrollment_year" id="enrollment_year" placeholder="2024">
                    </div>
                    <div class="form-group">
                ...
                <div class="form-buttons">
                    <button type="submit" class="btn-primary"><i class="fas fa-save"></i> Save Student</button>
        ...
        <div class="card">
            ...
            <div class="info-box">
                ...
                <span>Showing <strong><?php echo mysqli_num_rows($students); ?></strong> students. Newest students appear at the bottom.</span>
            </div>
                    ...
                    <tbody>
                        <?php if(mysqli_num_rows($students) > 0): ?>
                            ...
                            <tr>
                                ...
                                <td><?php echo $row['class'] ?: '-'; ?><?php echo $row['section'] ? ' - ' . $row['section'] : ''; ?></td>
                                ...
                                <td class="action-buttons">
                                    <button onclick="editStudent(<?php echo htmlspecialchars(json_encode($row)); ?>)" class="edit-btn">
                                        <i class="fas fa-edit"></i> Edit
                                    </button>
                                    <button onclick="confirmDelete(<?php echo $row['id']; ?>, '<?php echo addslashes($row['first_name'] . ' ' . $row['last_name']); ?>')" class="delete-btn">
                        ...
                        <?php else: ?>
                            <tr>
                                <td colspan="8" style="text-align: center; padding: 40px;">
                                    ...
                                    <p style="margin-top: 10px;">No students found. Add your first student!</p>
                                 </td>
                            </tr>
                        <?php endif; ?>
                    </tbody>
    ...
    <script>
        function editStudent(student) {
            ...
            document.getElementById('enrollment_year').value = student.enrollment_year;
            document.getElementById('status').value = student.status;
            
            // Change form header
            document.querySelector('.card-header h2').innerHTML = '<i class="fas fa-edit"></i> Edit Student';
            document.querySelector('.card-header i:last-child').className = 'fas fa-edit';
        ...
        function resetForm() {
            ...
            document.querySelector('.card-header h2').innerHTML = '<i class="fas fa-user-plus"></i> Add New Student';
            document.querySelector('.card-header i:last-child').className = 'fas fa-plus-circle';
        }
